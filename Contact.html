...
<body>
    ...
    <section class="cover" >
    <img src="img/Contact1.png" alt="Contact Banner" style="width: 100%; height: auto;">
    </section>
   ...
   <div class="contact-form"> 
    <form action="feedback.php" method="post"> <label for="name">Name:</label> 
     ...
     <br> <label for="message">Message:</label> <textarea id="message" name="message" class="form-input"></textarea>
     <br> 
 ...
 <p style="font-size: 23px; text-align: center;">ChatBot Support <img src="img/bot-mini.png" alt=""height="20"></p>
