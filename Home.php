...
<body>
    <header>
        <div class="logo">Food <b style="color: rgb(38, 211, 188);">Donate</b></div>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
        ...
        <div class="footer-center col-md-4 col-sm-6">
            ...
            <div>
              ...
              <div class="sociallist">
                <ul class="social">
                <li><a href=""><i class="fa fa-facebook" aria-hidden="true" style="font-size:50px; color: black;" ></i></i></a></li>
                <li><a href=""><i class="fa fa-twitter" aria-hidden="true"  style="font-size:50px; color: black;"></i></a></li>
                <li><a href=""><i class="fa fa-instagram" aria-hidden="true" style="font-size:50px; color: black;"></i></a></li>
